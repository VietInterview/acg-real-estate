...
jQuery('#cs_city_select_country').on('change', function () {
  ...
  jQuery(".loader-states").html("<img src='/iess/static/src/images/ajax-loader.gif' />");
...
jQuery('[name=cs_update_select_country]').change(function () {
  ...
  var dataString = 'country=' + this.value + '&action=cs_load_states';
  jQuery(".update-loader-states-" + id).html("<img src='/iess/static/src/images/ajax-loader.gif' />");
...
function add_package_to_list(admin_url, plugin_url) {
  ...
  jQuery(".package-loader").html("<img src='/iess/static/src/images/ajax-loader.gif' />");
  jQuery.ajax({
    type: "POST",
    url: admin_url,
    data: dataString,
...
function cs_load_location_ajax() {
  ...
  jQuery('.form-select-country').change(function () {
    ...
    var html = "<img src='/iess/static/src/images/ajax-loader.gif' />";
